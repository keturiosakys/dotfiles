...
local keys = {
	...
	{ key = "1", mods = "CTRL", action = act.SendKey({ key = "F1" }) },
	{ key = "2", mods = "CTRL", action = act.SendKey({ key = "F2" }) },
	{ key = "3", mods = "CTRL", action = act.SendKey({ key = "F3" }) },
	...
	--{ key = "Return", mods = "SUPER", action = act.ToggleFullScreen }, { key = "Return", mods = "ALT", action = act.DisableDefaultAssignment },
